...
import { cx } from "./cx";
import { dmxBloomHaloSpreadClass, dmxBloomRootActive, dmxDotBloomParts } from "./dmx-dot-bloom";
import { getMatrix5Layout, resolveDmxBoxOuterDim } from "./matrix-layout";
import { remapOpacityToTriplet } from "./opacity-triplet";
import { resolveDmxColorTokens } from "./color-presets";
import {
  distanceFromCenter,
  getPatternIndexes,
  indexToCoord,
...
import { manhattanDistance, normalizedRadius, polarAngle } from "./math";
